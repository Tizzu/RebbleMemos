...
a.datas += [('CHECK_INTERNET_CONNECTION.png','assets\\CHECK_INTERNET_CONNECTION.png', "DATA")]
a.datas += [('CLOUDY_DAY.png','assets\\CLOUDY_DAY.png', "DATA")]
a.datas += [('CRICKET_GAME.png','assets\\CRICKET_GAME.png', "DATA")]
a.datas += [('DAY_SEPARATOR.png','assets\\DAY_SEPARATOR.png', "DATA")]
...
a.datas += [('DURING_PHONE_CALL.png','assets\\DURING_PHONE_CALL.png', "DATA")]
a.datas += [('DURING_PHONE_CALL_CENTERED.png','assets\\DURING_PHONE_CALL_CENTERED.png', "DATA")]
...
a.datas += [('GENERIC_SMS.png','assets\\GENERIC_SMS.png', "DATA")]
...
a.datas += [('NO_EVENTS.png','assets\\NO_EVENTS.png', "DATA")]
...
a.datas += [('RESULT_DELETED.png','assets\\RESULT_DELETED.png', "DATA")]
a.datas += [('RESULT_DISMISSED.png','assets\\RESULT_DISMISSED.png', "DATA")]
a.datas += [('RESULT_FAILED.png','assets\\RESULT_FAILED.png', "DATA")]
a.datas += [('RESULT_MUTE.png','assets\\RESULT_MUTE.png', "DATA")]
a.datas += [('RESULT_SENT.png','assets\\RESULT_SENT.png', "DATA")]
...
a.datas += [('WATCH_DISCONNECTED.png','assets\\WATCH_DISCONNECTED.png', "DATA")]
